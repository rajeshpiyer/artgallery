...
">
	...
	<form action="" method="post" name="f1">
		<div class="form-group">
			...
			<input type="text" class="form-control" id="first" pattern="[a-zA-Z]+" name="first" placeholder="Enter First Name" required>
		</div>
		<div class="form-group"> 
			<label for="last">Last Name:</label>
			<input type="text" class="form-control" id="last" pattern="[a-zA-Z]+" name="last" placeholder="Enter Last Name" required>
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<input type="password" class="form-control" id="pwd" name="pass" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" placeholder="Enter password" required>
		</div>
		<div class="form-group">
    ...
    maxlength = "10">
		...
		<div class="form-group">
			...
			<input type="text" class="form-control" id="address" maxlength="50" name="add" placeholder="Enter Address" required>
		</div>
		<div class="form-group">
			<label for="st">State:</label>
			<input type="text" class="form-control" id="st" name="stat" pattern="[a-zA-Z]+" placeholder="Enter State" required>
		</div>
		<div class="form-group">
			<label for="pl">Country:</label>
			<input type="text" class="form-control" id="pl" name="place" pattern="[a-zA-Z]+" placeholder="Enter Country" required>
		</div>
        <b/>
        <b/>
