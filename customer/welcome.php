<div class="back-img back-img1 img-welcome">
   ...
   <?php
      ...
      header('Location:../index.php?page=customer_login');
      	 ...
      	 $cid =$_SESSION["uid"];
      	echo "<div class='text-center wel-div'>Welcome " .$_SESSION["name"] ."</div>";}
